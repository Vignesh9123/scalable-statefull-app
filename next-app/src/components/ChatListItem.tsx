...
function ChatListItem({chat, user}:{chat:Chat, user:User}) {
    ...
    const unreadCount = 3;
    return (
        <div key={chat.id} onClick={() => router.push(`/home/${chat.id}`)} className="chat-item flex items-center gap-3 bg-muted my-2 rounded-lg p-2 hover:bg-muted/70 duration-200 cursor-pointer transition-all">
